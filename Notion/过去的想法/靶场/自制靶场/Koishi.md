...
``` 
这里发现可以利用/proc/net/tcp和tcp6来发现ipv4和6端口服务,看了wp才知道,并且端口只能扫一次，对linux系统所了解的还是只有些基础命令罢了，发现第一个就是我们扫到的端口
```
  sl  local_address                         remote_address                        st tx_queue rx_queue tr tm->when retrnsmt   uid  timeout inode
   0: 00000000000000000000000000000000:8FCD 00000000000000000000000000000000:0000 0A 00000000:00000000 00:00000000 00000000  1000        0 14660 1 00000000202638e0 100 0 0 10 0
   1: 00000000000000000000000000000000:0016 00000000000000000000000000000000:0000 0A 00000000:00000000 00:00000000 00000000     0        0 14705 1 0000000034f0ce58 100 0 0 10 0
